 ...
 *
 */
public class Java2D_18  extends javax.swing.JFrame {
	/**
	 * Data members of the class
	 */
	private static final long serialVersionUID = 1L;
	private static final String TITLE = "Eighteenth Example: Responsive animation";
	...
	/**
	 * Unlike Java2D_17.DrawPanel, Java2D_18.DrawPanel implements Runnable
	 * so that the panel gets features of multithreading.
	 * 
	 */
	class DrawPanel extends JPanel implements Runnable {
		...
		public void paintComponent(Graphics g) {
			...
			GradientPaint grade = new GradientPaint(start, Color.RED, end,
					Color.BLUE);

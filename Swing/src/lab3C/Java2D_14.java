...
/**
 * Java2D_14 
 * An example using opacity - alpha values. 
 * 
 * 
 * @author Anthony Varghese
 *
 */
public class Java2D_14 extends JFrame {

	/**
	 * Data members of the class
	 */
	private static final long serialVersionUID = 1L;
	private static final String TITLE = "Fourteenth Example: Alpha";
	...
	public Java2D_14(String title) {
		...
		draw_panel = new JPanel(){
			...
			public void paintComponent(Graphics g){
				...
				GradientPaint grade = new GradientPaint( start, Color.RED, end, Color.BLUE );
				 ...
				 * what happens.
				 */
				a0 = AlphaComposite.getInstance( AlphaComposite.SRC_OVER, 0.5f );
				g2d.setComposite( a0 );

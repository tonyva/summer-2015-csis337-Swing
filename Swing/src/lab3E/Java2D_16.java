 ...
 *   This class uses a DrawPanel class that inherits from JPanel and implements Runnable
 * @author Anthony Varghese
 *
 */
public class Java2D_16 extends JFrame {
	/**
	 * Data members of the class
	 */
	private static final long serialVersionUID = 1L;
	private static final String TITLE = "Sixteenth Example: Responsive animation";
	...
	public Java2D_16() {
		...
		/*
		 * Set up a panel and a thread to move the object 
		 * 
		 */

 ...
 * Java3D_12
 *  
 * An example of user interaction with 3D transformations using the RotPosScalePathInterpolator class 
 * 
 * @author Anthony Varghese
 */
public class Java3D_12 extends Frame {
	...
	/*  */
	private final String TITLE = "Java 3D tutorial 12: User interaction with a PathInterpolator";
	private final int FRAME_X = 100;
	private final int FRAME_Y = 100;
	private final int FRAME_WIDTH = 400;
	private final int FRAME_HEIGHT = 300;

	private Java3D_12_Panel button_panel;
	...
	private RotPosScalePathInterpolator path;
	...
	public Java3D_12() {
		 ...
		 */
		button_panel = new Java3D_12_Panel( );
	...
	private BranchGroup createSceneGraph() {
		...
		float[] scales = { 1, 5, 1 };
		path = new RotPosScalePathInterpolator(	alpha1,
												transformations,
												new Transform3D(),
												knots,
												rotations,
	...
	public void paint(Graphics g){
		...
		Alpha currentAlpha = path.getAlpha();
		switch ( button_panel.getStatus() ){
			case 0:
				currentAlpha.setAlphaAtOneDuration( 0 );
				break;
			case 1:
				currentAlpha.setAlphaAtOneDuration( 500 );
				break;
			case 2:
				currentAlpha.setAlphaAtOneDuration( 1000 );
				break;
			case 3:
				currentAlpha.setAlphaAtOneDuration( 5000 );
				break;
			default:
				currentAlpha.setAlphaAtOneDuration( 0 );
		}
	...
	public static void main(String[] args) {
		Java3D_12 window = new Java3D_12();

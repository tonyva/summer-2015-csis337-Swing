 ...
 * Java3D_10
 *  
 * An example of 3D transformations using the PositionInterpolator class 
 * 
 * @author Anthony Varghese
 */
public class Java3D_10 extends Frame {
	...
	/*  */
	private final String TITLE = "Java 3D tutorial 10: PositionInterpolator";
	...
	private BranchGroup createSceneGraph() {
		...
		Alpha alpha5 = new Alpha(/* loops  = */   -1,
								...
								/* accel   = */  750,
								/* atZero  = */ 1000);
		PositionPathInterpolator path = new PositionPathInterpolator( alpha1,
													transformations,
													new Transform3D(),
													knots,
													points);
	...
	public static void main(String[] args) {
		Java3D_10 window = new Java3D_10();

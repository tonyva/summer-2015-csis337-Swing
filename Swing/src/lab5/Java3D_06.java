...
/**
 * Java3D_06
 * A 3D pyramid with intrinsic colors and harsh lighting. 
 * 
 * @author Anthony Varghese
 */

public class Java3D_06 extends Frame {
	...
	/*  */
	private final String TITLE = "Java 3D tutorial 6: Lighting";
	...
	private BranchGroup createSceneGraph() {
		...
		Material material = new Material(
				WHITE,  /* Ambient Color */
				WHITE,  /* Emissive Color -- change this to BLACK when the lights are Enabled. */
				WHITE,  /* Diffuse Color */
		...
		*/
		...
		/* Ambient lighting */
		AmbientLight amb_light = new AmbientLight(true, MAGENTA );
...
//		root.addChild( spot );
	...
	public static void main(String[] args) {
		Java3D_06 window = new Java3D_06();
